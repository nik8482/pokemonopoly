...
#define FLAG_HIDE_OMAR  0x264 // Unused Flag
...
#define FLAG_ABDI_DEFEATED                           (SYSTEM_FLAGS + 0x24) // Unused Flag
#define FLAG_NEAL_DEFEATED                           (SYSTEM_FLAGS + 0x25) // Unused Flag
...
#define FLAG_ALI_GIVEN                              (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_NIK_LORE                               (SYSTEM_FLAGS + 0x86) // Unused Flag
